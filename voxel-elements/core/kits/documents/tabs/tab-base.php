...
abstract class Tab_Base extends Sub_Controls_Stack {
	...
	public function register_controls() {
		...
		if ( method_exists( $this, 'register_runtime_tab_controls' ) && \vxe_is_runtime() ) {
			$this->start_controls_section( '_vx_runtime_tab_controls_'.$this->get_id() );
			$this->register_runtime_tab_controls();
